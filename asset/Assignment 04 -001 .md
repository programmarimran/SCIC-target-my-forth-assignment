...
| /\*function signature/sample \*/ function cashOut( money ) {           // You have to write your code here } |
| :---- |
...
| 🚩Challenge:   Input গুলো যদি object না হয়  তাহলে ফাংশন    "Invalid" return করবে।   |
| :---- |
